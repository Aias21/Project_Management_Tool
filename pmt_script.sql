...
--    ('Elon', 'Musk', 'b.gates@microsoft.com', '02 2361 123123', 'Client'),
...
--CREATE TABLE IF NOT EXISTS project_owners (project_owner_id SERIAL PRIMARY KEY, user_id INT REFERENCES users);
...
--    ('Xbox web interface','9 December 2023', '16 November 2024', 'Web development', 1,1),
--    ('Falcon X fuel distribution system','16 July 2023', '02 February 2025', 'Engineering', 2,2);
...
--CREATE VIEW assigned_tasks_employees AS SELECT  users.first_name AS Name, users.last_name AS "Family Name", employees.employee_id, projects.name AS Project , tasks.name as Task
